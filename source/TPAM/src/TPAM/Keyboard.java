...
public class Keyboard {
    ...
    public static void main(String... args) throws Exception {
        ...
        keyboard.keytype("Hello there, how are you?");
    }
    ...
    public void keytype(CharSequence characters) 
    {
        int length = characters.length();
        for (int i = 0; i < length; i++) 
        {
                char character = characters.charAt(i);
                System.out.println("Analyzing charat: " + character);
                if (character == '\\')
                {
                	i++;
                	switch(characters.charAt(i))
                	{
                		case 'a': doType(KeyEvent.VK_ALT,KeyEvent.VK_TAB); break;	
                		case 'b': doType(KeyEvent.VK_BACK_SPACE); break;
                		case 'e': doType(KeyEvent.VK_ESCAPE); break;
                		case 'n': doType(KeyEvent.VK_ENTER); break;
                		case 's': doType(KeyEvent.VK_ALT,KeyEvent.VK_S); break;
                		case 't':doType(KeyEvent.VK_TAB);  break;
                		case '\\': doType(KeyEvent.VK_BACK_SLASH); break;
                		case '4': doType(KeyEvent.VK_ALT,KeyEvent.VK_F4); break;
