...
try {
	...
	filter.setRequestorName(RequestorName)
     ...
     acl.listSessionRequestDetails(filter, res, requests)
...
//           }
    ...
    while (iter.hasNext()) {
    SessionRequest element = (SessionRequest) iter.next();
    System.out.println("ID: " + element.getRequestID() + " System name: " + element.getSystemName() + " Account name: " + element.getAccountName() + " Status " + element.getStatus());
