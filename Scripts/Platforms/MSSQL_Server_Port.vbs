...
sPort = WScript.Arguments.Item(2)
sConn="provider=sqloledb;data source=" & sServer & "," & sPort & ";initial catalog=master"
...
Err.Clear
Admin = WScript.Arguments.Item(3)
saPwd = WScript.Arguments.Item(4)
username = WScript.Arguments.Item(5)
passwd = WScript.Arguments.Item(6)
WScript.Echo saPwd
...
passwd = WScript.Arguments.Item(4)
