...
import com.edmz.api.filters.CollectionFilter;
...
try {
    ...
    acl.listCollections(filter, res, collections)
	...
	Iterator<Collection> iter = collections.iterator()
            while (iter.hasNext()) {
                ...
                System.out.println("collection name: " + element.getCollectionName() + " desc: " + element.getDescription() + "PsmDpaAffinity: " + element.getPsmDpaAffinity()  )
            }
