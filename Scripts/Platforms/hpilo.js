...
var LogFile = "HPiLO/telnet_session.log";
...
var ScriptTemplate = "HPiLO/hp_" + Command + ".template"; 
...
var ScriptScenario = "HPiLO/hp_" + Command + ".script"; 
...
var RunStr = "../tst10.exe /r:" + ScriptScenario + " /o:" + LogFile;
