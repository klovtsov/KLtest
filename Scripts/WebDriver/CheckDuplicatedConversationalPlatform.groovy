...
def CheckControls (driver, TPAM, PlatformName) {
	...
	if (myselect.getFirstSelectedOption().getText() != "Conversational") {
...
//	}	
	...
	if (driver.findElement(By.id("SSHFl")).isSelected()) {
			println("DSS Key checkbox is checked!")
			Success = false
	}	

	if (!driver.findElement(By.id("PasswordFl")).isSelected()) {
			println("Password checkbox is not checked!")
			Success = false
	}	
...
//	}	
	...
	if (driver.findElement(By.id("EnablePwdFl")).isSelected()) {
			println("Enable Password checkbox is checked!")
			Success = false
	}	

	if (driver.findElement(By.id("NetBiosNameFl")).isSelected()) {
			println("NETBIOS name checkbox is checked!")
			Success = false
	}	

	if (driver.findElement(By.id("DomainNameFl")).isSelected()) {
			println("Domain name checkbox is checked!")
			Success = false
	}	
	...
	if (!driver.findElement(By.id("PAMUploadBtnSelect")).isEnabled()) {
			println("Select File button is not enabled!")
			Success = false
	}	
...
try {
	...
	CheckControls(driver, TPAMaddress, PlatformName)
