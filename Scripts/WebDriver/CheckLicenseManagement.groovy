...
def LicenseManagement(driver, TPAM, ResultFile) {
    ...
    TPAMaddr = "https://" + TPAM + "/admin/LicenseManagement.asp" 
    driver.get(TPAMaddr)
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.MILLISECONDS)
	
	WebElement table = driver.findElement(By.id("LicenseLimitsTable"))
...
try {
    ...
    LicenseManagement(driver, TPAMaddress, ResultFile)
