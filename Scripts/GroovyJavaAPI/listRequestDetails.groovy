...
try {
	...
	filter.setRequestorName("User=Myself")
     ...
     acl.listRequestDetails(filter, res, requests)
    ...
    System.out.println(element.getRequestID() + " " + element.getSystemName() + "\\" + element.getAccountName()  + " " + element.getUserName() + " " + element.getRequestStatus() )
